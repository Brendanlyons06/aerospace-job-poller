...
export default async function Home() {
  ...
  return (
    <main>
      ...
      <footer className="shell"><span>AeroScout</span><nav><a href="/privacy">Privacy</a><a href="/terms">Terms</a><a href="/contact">Contact</a><a href="https://github.com/Brendanlyons06/aerospace-job-poller" target="_blank" rel="noreferrer">GitHub ↗</a></nav></footer>
    </main>
  );
}
